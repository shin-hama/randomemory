    ...
    <Layout title="Terms of Use">
      <Container maxWidth="md" sx={{ pt: 2 }}>
        ...
        <p>
          ...
          all the trademarks, copyright, database rights, and other intellectual property rights
          related to it, still belong to Coppla.
        </p>
        <p>
          Coppla is committed to ensuring that the app is as useful and efficient as possible. For
        ...
        <p>
          The RandoMemory app stores and processes personal data that you have provided to us, to
          ...
          mean that the RandoMemory app won&apos;t work properly or at all.
        </p>
        <div>
        ...
        <p>
          You should be aware that there are certain things that Coppla will not take responsibility
          ...
          Coppla cannot take responsibility for the app not working at full functionality if you
        ...
        <p>
          Along the same lines, Coppla cannot always take responsibility for the way you use the app
          i.e. You need to make sure that your device stays charged – if it runs out of battery and
          you can&apos;t turn it on to avail the Service, Coppla cannot accept responsibility.
        </p>
        <p>
          With respect to Coppla&apos;s responsibility for your use of the app, when you&apos;re using the
          ...
          we can make it available to you. Coppla accepts no liability for any loss, direct or
        ...
        <p>
          ...
          want to keep using the app. Coppla does not promise that it will always update the app so
          that it is relevant to you and/or works with the version that you have installed on your
        ...
        <p>These terms and conditions are effective as of 2022-11-01</p>
        <p>
          <strong>Contact Us</strong>
        </p>
        <p>
          If you have any questions or suggestions about my Terms and Conditions, do not hesitate to
          contact me at htysivista@gmail.com.
        </p>
        <p>
